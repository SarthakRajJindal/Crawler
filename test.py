...
headers = {
  ...
  'Referer': 'https://ieeexplore.ieee.org/document/8301529/references',
...
for x in references:
    ...
    if 'links' in x:
        ...
        if 'documentLink' in y:
            ...
            papers.append(y['documentLink'])

#make a dictionary of the papers with values 0
for paper in papers:
    papers_dict[paper] = 0
