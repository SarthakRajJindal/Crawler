        ...
        for x in references:
            ...
            if 'links' in x:
                ...
                if 'documentLink' in y:
                    ...
                    full_url = 'https://ieeexplore.ieee.org' + y['documentLink'] + '/references'
                    if(full_url not in visited.keys()):
                        queue.append(full_url)
                        visited[full_url] = False
